	...
	//RoomBooking
		...
		//Room
				...
				public void testCreateSubject() {
					...
					assertEquals("345632", allsubjects.get(0).getName());
				}
				...
				public void testCreateFeedbackNull() {
					...
					// check error
					assertEquals("Feedback session cannot be empty!", error);
				...
				public void testCreateSessionNull() {
					...
					// check error
					assertEquals("Session cannot have an empty room Booking or a negative ID", error);
